...
```sh
go build -o main && sudo docker build -t lclemente/quic-demo . && sudo docker run --rm -it --cap-add=NET_ADMIN -p 8000-8009:8000-8009 -p 8000-8009:8000-8009/udp -v /etc/letsencrypt/live/quic.clemente.io:/certs lclemente/quic-demo
