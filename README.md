...
```sh
go-bindata-assetfs html/... && go build -o main && sudo docker build -t lclemente/quic-demo . && sudo docker run --rm -it --cap-add=NET_ADMIN -p 8000-8009:8000-8009 -p 8000-8009:8000-8009/udp -p 7000:7000 -p 443:7000/udp -v /etc/letsencrypt/live/quic.clemente.io:/certs lclemente/quic-demo
